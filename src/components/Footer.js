        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted partner for Hajj, Umrah, and global tourism experiences. 
              We provide exceptional service and unforgettable journeys that create 
              lasting memories.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <div className="flex items-center">
                ...
                <span>info@alhijrahtourism.com</span>
              </div>
              <div className="flex items-start">
                ...
                <span>123 Tourism Street<br />Travel City, TC 12345</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Al-Hijrah Tourism. All rights reserved.
            </p>
